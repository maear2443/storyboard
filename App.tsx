...
const App: React.FC = () => {
    ...
    if (!apiKey && !process.env.API_KEY) {
     ...
     for (const scene of visibleScenes) {
         if (!scene.imageUrl && !scene.isGenerating) {
             ...
             // Small delay to help with rate limits even with personal keys
  ...
  return (
    <div className="min-h-screen flex flex-col pb-12 bg-slate-950 print:bg-white print:pb-0">
      ...
      <button
        onClick={generateAllVisible}
        className="md:hidden fixed bottom-6 right-6 w-14 h-14 bg-cyan-600 rounded-full shadow-2xl flex items-center justify-center text-white z-50 active:scale-95 transition-transform no-print"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
